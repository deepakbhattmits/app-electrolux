        ...
        return (
            <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
                <div className="rounded-3xl border border-zinc-200/80 bg-zinc-50 p-8 text-zinc-700 shadow-sm">
                    <h1 className="text-3xl font-semibold text-zinc-950">Your cart is empty</h1>
                    <p className="mt-4 text-base leading-7">Add products to your cart and you&apos;ll see them listed here.</p>
                    <Link
                        href="/"
        ...
        <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
                <section className="flex-1 space-y-4">
                    <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-sm">
                        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                <p className="text-sm font-medium uppercase tracking-[0.2em] text-zinc-500">Shopping cart</p>
                                <h1 className="mt-2 text-3xl font-semibold text-zinc-950">{quantity} items</h1>
                            </div>
                            <Link
                                href="/"
                        ...
                        <div className="mt-6 grid gap-4 sm:grid-cols-2">
                            <div className="rounded-3xl border border-zinc-200/80 bg-zinc-50 p-5 shadow-sm">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-zinc-500">Products in cart</p>
                                ...
                                <div className="grid gap-6 lg:grid-cols-[160px_minmax(0,1fr)] lg:items-center">
                                    ...
                                    <div className="space-y-4 min-w-0">
                                        <div>
                                            ...
                                            <p className="mt-2 text-sm text-zinc-600">${item.price.toFixed(2)} each</p>
                                        </div>
                                        ...
                                        <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                                            ...
                                            <div className="flex flex-wrap items-center gap-3 text-sm text-zinc-600">
                                                <p className="font-medium text-zinc-950 min-w-0 break-words">Total: ${(item.price * item.quantity).toFixed(2)}</p>
                                                <button
                                                    type="button"
                ...
                <aside className="w-full max-w-md space-y-4 rounded-3xl border border-zinc-200/80 bg-zinc-50 p-6 shadow-sm">
                    <div>
                        <p className="text-sm font-medium uppercase tracking-[0.2em] text-zinc-500">Order summary</p>
